...
class ErrCode
{
    ...
    // 错误：头部入队受限
    const FRONT_ENQUEUE_RESTRICTED = 2;

    // 错误：头部出队受限
    const FRONT_DEQUEUE_RESTRICTED = 3;

    // 错误：尾部入队受限
    const REAR_ENQUEUE_RESTRICTED = 4;

    // 错误：尾部出队受限
    const REAR_DEQUEUE_RESTRICTED = 5;

    // 错误：出队端与入队端不一致
    const DIFFERENT_ENDPOINT = 6;
