...
class IDNumberValidator
{
     ...
     * 第 1 位为省份简称（汉字）
     * 第 2 位为发牌机关代号（A-Z的字母）
     * 第 3 到第 7 位为序号（由字母或数字组成，但不存在字母 I 和 O，防止和数字1、0混淆，另外最后一位可能是“挂学警港澳使领”中的一个汉字）
     *
     * 2.新能源车牌
     * 第 1 位和第 2 位与传统车牌一致，第 3 到第 8 位为序号（比传统车牌多一位）
     *
     * 新能源车牌的序号规则
     * 小型车：第 1 位只能是字母 D 或 F，第 2 位可以是数字或字母，第 3 到 6 位必须是数字
